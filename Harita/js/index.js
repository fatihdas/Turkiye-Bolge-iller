$("#data-table").DataTable({
  ...
  columnDefs: [
    // dataTable tr karater sırasına göre sıralar.
    {
      type: "turkish",
      targets: "_all",
    },
  ...
  language: {
    // Tr dil dosyası çağırır ve kullanır.
    url: "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Turkish.json",
  },
  order: [[1, "asc"]], /// Birinci kolondaki değerleri küçükten büyüğüe göre sıralar.
  initComplete: function () {
    // dataTable yüklemesi tamamlandıktan sonra tr satırlarının içini okur ve renklendirir.
...
$(".button-filter").on("click", "a", function () {
  ///  Filtreleme butonlarına tıklandığı anda butonda ki texti arar ve tabloya sonuçları yazar.
  table.search($(this).text()).draw();
  console.log($(this).text());
});
$("button").click(function () {
  // Temizle butonuna basıldığında filtrelemeyi temizler bütün sonuçları ekrana getirir.
